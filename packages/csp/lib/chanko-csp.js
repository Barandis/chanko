...
function isReduced(value) {
  return !!(value === null || value === void 0 ? void 0 : value[_chanko_xduce_tools__WEBPACK_IMPORTED_MODULE_0__["protocols"].reduced]);
}
/**
...
function handleSend(channel, value, handler) {
  ...
  if (channel.buffer && !Object(modules_buffer__WEBPACK_IMPORTED_MODULE_2__["isFull"])(channel.buffer)) {
    handler.commit();
    const done = isReduced(channel.xform[_chanko_xduce_tools__WEBPACK_IMPORTED_MODULE_0__["protocols"].step](channel.buffer, value));
  ...
  if (channel.buffer && Object(modules_buffer__WEBPACK_IMPORTED_MODULE_2__["count"])(channel.buffer) > 0) {
    ...
    for (;;) {
      ...
      if (sendHandler.active) {
        ...
        if (isReduced(channel.xform[_chanko_xduce_tools__WEBPACK_IMPORTED_MODULE_0__["protocols"].step](channel.buffer, sender.value))) {
          close(channel);
        }
      }
    }
...
function close(channel) {
  ...
  if (channel.buffer) {
    channel.xform[_chanko_xduce_tools__WEBPACK_IMPORTED_MODULE_0__["protocols"].result](channel.buffer);
...
/* harmony import */ var _chanko_xduce_tools__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @chanko/xduce-tools */ "../xduce-tools/lib/chanko-xduce-tools.js");
/* harmony import */ var _chanko_xduce_tools__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_chanko_xduce_tools__WEBPACK_IMPORTED_MODULE_5__);
...
function handlerTransducer(xform, handler = DEFAULT_HANDLER) {
  return {
    [_chanko_xduce_tools__WEBPACK_IMPORTED_MODULE_5__["protocols"].step](buffer, input) {
      try {
        return xform[_chanko_xduce_tools__WEBPACK_IMPORTED_MODULE_5__["protocols"].step](buffer, input);
      } catch (ex) {
        return handleException(buffer, handler, ex);
      }
    },

    [_chanko_xduce_tools__WEBPACK_IMPORTED_MODULE_5__["protocols"].result](buffer) {
      try {
        return xform[_chanko_xduce_tools__WEBPACK_IMPORTED_MODULE_5__["protocols"].result](buffer);
      } catch (ex) {
        return handleException(buffer, handler, ex);
      }
    }
...
const bufferReducer = {
  [_chanko_xduce_tools__WEBPACK_IMPORTED_MODULE_5__["protocols"].init]() {
    throw Error("init not available");
  },
